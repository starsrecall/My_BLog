Style Guide for C[](about:blank#style-guide-for-c "Permalink to this heading")
===============================================================================
...
Line Length[](about:blank#line-length "Permalink to this heading")
-------------------------------------------------------------------
...
int first\_collected\_integer\_value\_from\_user \= get\_int("Integer please: ");
int second\_collected\_integer\_value\_from\_user \= get\_int("Another integer please: ");
int product\_of\_the\_two\_integer\_values\_from\_user \= first\_collected\_integer\_value\_from\_user \* second\_collected\_integer\_value\_from\_user;
...
Comments[](about:blank#comments "Permalink to this heading")
-------------------------------------------------------------
...
Library Headers[](about:blank#library-headers "Permalink to this heading")
---------------------------------------------------------------------------
...
Conditions[](about:blank#conditions "Permalink to this heading")
-----------------------------------------------------------------
...
Switches[](about:blank#switches "Permalink to this heading")
-------------------------------------------------------------
...
Functions[](about:blank#functions "Permalink to this heading")
---------------------------------------------------------------
...
Indentation[](about:blank#indentation "Permalink to this heading")
-------------------------------------------------------------------
...
Loops[](about:blank#loops "Permalink to this heading")
-------------------------------------------------------

### for[](about:blank#for "Permalink to this heading")
...
### while[](about:blank#while "Permalink to this heading")
...
### do … while[](about:blank#do-while "Permalink to this heading")
...
Pointers[](about:blank#pointers "Permalink to this heading")
-------------------------------------------------------------
...
Variables[](about:blank#variables "Permalink to this heading")
---------------------------------------------------------------
...
Structures[](about:blank#structures "Permalink to this heading")
-----------------------------------------------------------------
...
本文转自 [https://cs50.readthedocs.io/style/c/](https://cs50.readthedocs.io/style/c/)，如有侵权，请联系删除。